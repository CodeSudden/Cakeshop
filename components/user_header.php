<header class="header">
    ...
    <div class="icons">
        ...
        ?>
        <a href="wishlist.php"><i class="fas fa-heart"></i><sup><?= $total_wishlist_items; ?></sup></a>
        ...
        <a href="cart.php"><i class="fas fa-shopping-cart"></i><sup><?= $total_cart_items; ?></sup></a>
